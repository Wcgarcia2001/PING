...
export default function IPChecker() {
  ...
  const handleCheck = async () => {
    ...
    try {
      ...
      // Verificar en lotes pequeños con actualización de progreso
      const batchSize = 5;
      ...
      <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-center gap-2">
                {serverStatus?.online ? (
                  <>
                    ...
                    <span className="text-sm text-green-600 font-medium">Servidor OK</span>
                  </>
                ) : (
                  <>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                ...
                <div className="bg-green-50 p-3 rounded-lg border border-green-200">
                  <p className="text-green-700 text-xs mb-1">En línea</p>
                  <p className="text-2xl font-bold text-green-600">
                    {results.summary.online}
                  </p>
                </div>
                <div className="bg-red-50 p-3 rounded-lg border border-red-200">
                  <p className="text-red-700 text-xs mb-1">Offline</p>
                  <p className="text-2xl font-bold text-red-600">
                    {results.summary.offline}
                  </p>
                </div>
                <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                  <p className="text-yellow-700 text-xs mb-1">Timeout</p>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 px-3 py-1 text-xs text-gray-600 hover:bg-gray-200 rounded transition"
                    >
                      Limpiar
                    </button>
                    <button
                      onClick={exportToCSV}
                      className="flex-1 flex items-center justify-center gap-1 bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700 transition text-xs"
                    >
                ...
                <table className="w-full border-collapse text-sm">
                  <thead>
                    <tr className="bg-gray-100">
                      <th className="border border-gray-300 px-2 py-2 text-left text-xs">Estado</th>
                      <th className="border border-gray-300 px-2 py-2 text-left text-xs">IP</th>
                      <th className="border border-gray-300 px-2 py-2 text-left text-xs">Nombre</th>
                      <th className="border border-gray-300 px-2 py-2 text-left text-xs">Torre</th>
                    </tr>
                  </thead>
                  <tbody>
                    {getFilteredEntries().length > 0 ? (
                      ...
                      <tr>
                        <td colSpan="4" className="border border-gray-300 px-2 py-4 text-center text-gray-500 text-xs">
                          No hay resultados
                        </td>
                      </tr>
                    )}
        ...
        <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-3">
          <p className="text-xs text-gray-700">
            <strong>Formato:</strong> IP,Nombre,Torre,Comunidad
            <br />
            <code className="bg-white px-2 py-1 rounded text-xs">
              192.168.1.1,Server,Torre A,Norte
            </code>
          </p>
        </div>
      </div>
